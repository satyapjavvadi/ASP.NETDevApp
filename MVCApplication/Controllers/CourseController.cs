...
namespace MVCApplication.Controllers
{
    ...
    {
        private ShabhiAcademyDbContext db = new ShabhiAcademyDbContext();
        // GET: Course
        ...
        public ActionResult Online()
        {
            ...
            //var courses = from c in db.Courses where c.IsVirtual orderby c.Name select c;
        ...
        public ActionResult Create(Course course)
        {
            try
            {
                ...
                {
                    using(var context = new ShabhiAcademyDbContext())
                    {
